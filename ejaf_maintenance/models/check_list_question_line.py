...
class CheckListQuestionLine(models.Model):
    ...
    technical_inspection_id = fields.Many2one(comodel_name="technical.inspection", string="TI", required=False)
    site_id = fields.Many2one('maintenance.equipment', related='technical_inspection_id.equipment_id', string='Site')
